...
def test_fine_aligned_jsons(test_data_folder, test_data_set):
    ...
    #Values for the Q1023 dataset
    files = [
                'input_fine_alignment_1_0_1.json',
                'output_fine_alignment_1_0_1.json',
                'input_fine_alignment_2_0_1.json',
                'output_fine_alignment_2_0_1.json'
            ]
    for f in files:
        assert tu.compare_file_in_folders(f, test_folder, ref_folder) == True
...
def test_point_match_in_place(test_data_folder, test_data_set):
    ...
    #Values for the Q1023 dataset
    files = [
                'in_section_pairs_S1_RoughAligned_z0000.json',
                'in_section_pairs_S1_RoughAligned_z0001.json',
