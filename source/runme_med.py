...
if __name__ == "__main__":
    owner = "Testing"
    mediantemplate = "../DockerDataFolders/median_record_template.json"
    firstsection = 0
    lastsection = 1
    num_iter = 20
    ...
    for sectnum in range(firstsection,lastsection+1):
        ...
        for ch in channels:
            ...
            if close_stack:
            	...
            	#run
            	cmd1 = "docker exec rm_container python -m rendermodules.intensity_correction.calculate_multiplicative_correction --render.port 8080 --input_json %s"%medianfile
