...
export JSONDIR=/nas5/data/$PROJECT/processed/tilepairfiles1
...
echo         /pipeline/spark/bin/spark-submit --conf spark.default.parallelism=$PARALLELISM --driver-memory 19g --executor-memory 50g\
 --executor-cores 44 --deploy-mode cluster\
 --class org.janelia.render.client.spark.SIFTPointMatchClient\
 --name PointMatchFull\
 --master spark://master:6066\
