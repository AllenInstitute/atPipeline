	...
	for i in range (0,1):
			...
			if not os.path.exists(flatfield_dirname):
				...
				for ch in channels:
					...
					if ch=="GAD2":
						#print "Im gfp"
						psf_file = "/nas/data/M246930_Scnn1a_4/processed/psfs/psf_GAD2.tif"
						scale_factor = 2
						bgrd_size = 20
					#if ch=="DAPI_1":
						#print "im dapi"
						psf_file = "/nas/data/M246930_Scnn1a_4/processed/psfs/psf_DAPI.tif"
                                                scale_factor = 3
                                                bgrd_size = 20
					#elif ch=="GABA":
						#print "im geph"
					#	psf_file = "/nas/data/M246930_Scnn1a_4/processed/psfs/psf_GABA.tif"
                                         #       scale_factor = 2
                                        #        bgrd_size = 20
					#elif ch=="GluN1":
						#print "im psd"
						psf_file = "/nas/data/M246930_Scnn1a_4/processed/psfs/psf_GluN1.tif"
                                                scale_factor = 5
                                                bgrd_size = 20
					else:
						psf_file = ""
				...
				for ch in channels:
					if ch.find("DAPI")>-1:
						...
						#stitched_dapi_stack = "Stitched_%d_DAPI_1"%(int(session))
						deconv_stack = "Deconvolved_%d_%s"%(int(session),ch)
						flatfield_stack = "Flatfieldcorrected_%d_%s"%(int(session),ch)
						stitched_stack = "Stitched_%d_%s"%(int(session),ch)
